...
if ($.isNode()) {
    cookiesArr = process.env.Readck2 ? process.env.Readck2.split("@") : []
...
function read(url1) {
    return new Promise(async (resolve) => {
      ...
      let headers = {
            ...
            User-Agent:"Mozilla/5.0 (Linux; Android 10; MIX 2S Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045709 Mobile Safari/537.36 MMWEBID/4533 MicroMessenger/8.0.6.1900(0x2800063D) Process/tools WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64"
        }
        let options = {
            headers,
            url
