...
function redrain(){
    ...
    echo "30 0-23/1 * * *  . /scripts/docker/auto_help.sh export > /scripts/logs/auto_help_export.log &&  . /scripts/docker/auto_help.sh export > /scripts/logs/auto_help_export.log && node   /scripts/jd_half_redrain.js |ts >> /scripts/logs/jd_half_redrain.log 2>&1" >> /scripts/docker/merged_list_file.sh
    echo "0 0-23/1 * * *  . /scripts/docker/auto_help.sh export > /scripts/logs/auto_help_export.log &&  . /scripts/docker/auto_help.sh export > /scripts/logs/auto_help_export.log && node   /scripts/jd_super_redrain.js |ts >> /scripts/logs/jd_super_redrain.log 2>&1" >> /scripts/docker/merged_list_file.sh
}
